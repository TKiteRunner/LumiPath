    ...
    <div className="min-h-screen flex items-center justify-center bg-surface px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-text-muted text-sm mt-1">照亮你的成长路径</p>
        </div>

        <div className="macaron-card p-6">
          <h2 className="text-lg font-semibold text-text-main mb-5">登录账号</h2>
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs text-text-muted bg-white px-2">
              或
            </div>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2.5 rounded-md border border-border bg-white text-text-main text-sm font-medium hover:bg-macaron-pink/10 transition-colors"
          >
          ...
          <p className="text-center text-sm text-text-muted mt-4">
            还没有账号？{" "}
            <Link href="/register" className="text-text-main font-medium underline">
              立即注册
            </Link>
          </p>
        </div>
